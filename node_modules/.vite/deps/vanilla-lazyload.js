...
//#endregion
//#region node_modules/vanilla-lazyload/dist/lazyload.min.js
var require_lazyload_min = /* @__PURE__ */ __commonJSMin(((exports, module) => {
	(function(e, t) {
		...
		const e = "undefined" != typeof window, t = e && !("onscroll" in window) || "undefined" != typeof navigator && /(gle|ing|ro)bot|crawl|spider/i.test(navigator.userAgent), a = e && window.devicePixelRatio > 1, n = {
		...
		})(e, f, t), y = (e) => I(e, null), k = (e) => null === E(e), A = (e) => E(e) === m, L = [
			u,
			g,
			b,
			h
			...
			r,
			i
		], F = [_], j = (e) => !!e[c], B = (e) => e[c], J = (e) => delete e[c], S = (e, t) => {
			if (j(e)) return;
			const a = {};
			t.forEach(((t) => {
			...
			ee(n) || ((e, t, a) => {
				ee(e) || (e.llEvLisnrs = {});
				Y(e, "VIDEO" === e.tagName ? "loadeddata" : "load", t), Y(e, "error", a);
			})(n, ((s) => {
				((e, t, a, n) => {
					const s = A(t);
			...
			"IFRAME",
			"VIDEO"
		], ce = (e) => e.use_native && "loading" in HTMLImageElement.prototype, _e = (e, t, a) => {
		...
		return me.prototype = {
			...
			if (t) if (t.length) for (let a, n = 0; a = t[n]; n += 1) l(e, a);
			else l(e, t);
		})(me, window.lazyLoadOptions), me;
	}));
}));
//#endregion
export default require_lazyload_min();
